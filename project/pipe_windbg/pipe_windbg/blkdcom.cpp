...

{
    ...
    printf("KD: Sent type %u control packet.\n", PacketType);
...
Retry:
    ...
    printf("KD: Received type %u packet.\n", Header->PacketType);
    ...
    if (BlKdComReceivePacket() != FALSE) {
        ...
        switch (BlKdStaticPacket.Header.PacketType) {
            ...
            case KD_PACKET_TYPE_KD_RESET: {
                ...
                printf("KD: Received RESET after send.\n");
            ...
            case KD_PACKET_TYPE_KD_RESEND: {
                ...
                printf("KD: Received RESEND after send.\n");
